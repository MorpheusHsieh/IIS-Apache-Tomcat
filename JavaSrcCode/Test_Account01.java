...
public class Test_Account01
{
  public static void main(String[] args)
  {
    ...
    String sqlstr = "SELECT * FROM Account ORDER BY WorkNo";
    int rows = ac.ExecuteQuery(sqlstr);
    ...
    if (result > 0)
      System.out.println("權限更換成功..." );
    else
      System.out.println("權限更換失敗..." );
    ShowUser(ac);
  ...
  public static void ShowUser(Account01 ac)
  {
    ...
    int cols = ac.getFields();
    int rows = ac.getRecords();
